...
test_that("Estimated parameters equal expected values", {
  expect_equal(
    taskResult$finalParameters, c(14.024, 6.244, 1.3e-6),
    tolerance = 0.01
  )
})
...
test_that("Estimated parameters equal expected values", {
  expect_equal(
    taskResult$finalParameters, c(8.420, 5.373, 0.011),
    tolerance = 0.01
  )
})

test_that("Hessian-based standard deviations equal expected values", {
  expect_equal(taskResult$sd, c(2.308, 0.893, 0.002), tolerance = 0.01)
})
