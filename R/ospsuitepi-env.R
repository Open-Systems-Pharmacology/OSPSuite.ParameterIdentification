...
# ospsuite.parameteridentification, It is not exported and should not be
# directly manipulated by other packages.
...
#'
#' @return Value of the setting stored in `piEnv`. If the setting does not exist,
#'   an error is thrown.
#' @export
#'
#' @examples
...
getOSPSuitePISetting <- function(settingName) {
  ...
  # Evaluate if the object is a function.
  # This is required since some properties are defined as function reference
  if (is.function(obj)) {
    return(obj())
  }
